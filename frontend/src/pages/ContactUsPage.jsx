    ...
    return (
      <Box bg="white" minH="100vh">
        ...
        <Box px={{ base: 4, md: 20 }} py={10}>
          {/* Header Section */}
          <Text fontSize={{ base: "2xl", md: "3xl" }} fontWeight="light" textAlign="left" mb={2}>
            CONTACT US
          </Text>
          ...
          >
            ...
            <VStack align="start" spacing={6} flex="1">
              <Text fontSize={{ base: "3xl", md: "4xl" }} fontWeight="bold" color="grey.600">
                Send us <Text as="span" color="#97C33A">Feedback</Text>
              </Text>
